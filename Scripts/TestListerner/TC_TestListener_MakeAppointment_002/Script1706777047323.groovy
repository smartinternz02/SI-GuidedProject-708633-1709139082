...
WebUI.click(findTestObject('Cura_MakeAppointment_OR/Page_CURA Healthcare Service/td_22'))

WebUI.setText(findTestObject('Cura_MakeAppointment_OR/Page_CURA Healthcare Service/textarea_Comment_comment'), 'MakeAppointment SetUp And TearDown with TestcaseListener')
